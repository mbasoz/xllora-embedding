...
training_data_file=../data/xllora-hausa.csv # The script expects sent0 (anchor sentence), sent1 (positive sentence) and hard_neg (hard negative sentence) columns in the training dataset
