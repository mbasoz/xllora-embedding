...
# This is the example to demonstrate the data synthesis settings for the negative examples
...
output_data_path=../data/xllora-syn-hausa-neg.csv # output csv path to save the data
...
lora_model=../models/lora-gemma327b-xllora-neg
